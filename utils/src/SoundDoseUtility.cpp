...
SoundDoseUtility::SoundDoseUtility(pal_device_id_t deviceId) {
...
int SoundDoseUtility::startSoundDoseComputation(pal_device_id_t deviceId) {
...
void SoundDoseUtility::stopSoundDoseComputation(pal_device_id_t deviceId) {
